...
def processFrame(image):
	...
	if pred is not None:
		...
		for one_mask,bbox,cls,conf in zip(pred_masks_np,nbboxes,pred_cls,pred_conf):
			...
			color=[np.random.randint(255),np.random.randint(255),np.random.randint(255)] # color change 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='images/1.jpg', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--showfps', action='store_true', help='show fps on video/webcam')
